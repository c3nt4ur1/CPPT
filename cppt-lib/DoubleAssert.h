...
public:
    ...
    DoubleAssert(int testNum, string testName, double expected, double actual)
            : Assertion(std::fabs(expected - actual) < 1e-10, testName, testNum){
        this->expected = expected;
        this->actual = actual;
...
class DoubleAssertDiffers : public Assertion{

public:
    bool passed;

    DoubleAssertDiffers(string testName, double expected, double actual)
            : Assertion(std::fabs(expected - actual) > 1e-10, testName){
    ...
    DoubleAssertDiffers(int testNum, string testName, double expected, double actual)
            : Assertion(std::fabs(expected - actual) > 1e-10, testName, testNum){
        this->expected = expected;
        this->actual = actual;
